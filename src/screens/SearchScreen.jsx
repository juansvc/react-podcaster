...
import search_icon_black from '../icons/search_icon_black.svg'
import cancel_close_delete_icon from '../icons/cancel_close_delete_icon.svg'
...
function SearchScreen(props) {
  ...
  useEffect(() => {
    ...
    return () => {
      source.cancel(
        'Component unmounted or 24 hours changed'
      )
    }
